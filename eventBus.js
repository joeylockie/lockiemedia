...
const EventBus = (function() {
    ...
    function publish(eventName, data) {
        ...
        if (events[eventName]) {
            ...
            // console.log(`[EventBus] No listeners for event: ${eventName}`); // Optional: log if no listeners
        }
    }

    // Expose the public methods
    // In a module system, these would be exported. For now, attach to window.
    window.EventBus = {
        subscribe,
        unsubscribe,
        publish
    ...
    console.log("EventBus.js loaded and initialized.");
    return window.EventBus; // Return it for immediate use if needed, though window.EventBus is primary
})();
